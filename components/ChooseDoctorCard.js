  ...
  return (
    <TouchableOpacity className=" m-2" onPress={() => {
      ...
      <Card className=' pt-8 pl-3 flex-row h-52   shadow-none  justify-center' >
        ...
        <Image className="h-16 w-16 border-2 border-rose-600 rounded-full" source={require('../assets/images/user2.png')} />
        <Image className="h-20 w-20 rounded-full" source={require('../assets/images/user2.png')} />
        <Image className="h-16 w-16 rounded-full" source={require('../assets/images/user2.png')} />
        </View>
          <Card.Content className='flex '>
            <View className='flex justify-center items-center'>
              ...
              <DoctorBookButton className='' title='Chat Now'/>
            </View>
          </Card.Content>
        </View>
